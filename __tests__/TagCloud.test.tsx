...
//         expectToMatchSnapshot(<TagCloud minSize={12} maxSize={30} tags={data} randomSeed={42} />);
//     });
//
//     it("should render not shuffled tags", () => {
//         expectToMatchSnapshot(
//             <TagCloud shuffle={false} minSize={12} maxSize={30} tags={data} randomSeed={42} />
//         );
//     });
//
...
//         act(() => {
//             cloud = create(
//                 <TagCloud minSize={12} maxSize={30} tags={data} randomNumberGenerator={rng} />
//             );
//         });
