...
export interface TagCloudProps extends React.RefAttributes<void> {
    ...
    randomNumberGenerator?: (() => number) | undefined;
    containerComponent?: keyof React.ReactHTML | undefined;
    ...
    /** Fired when calling context menu over a tag */
    onContextMenu?: TagEventHandler | undefined;
}
...
export type RendererFunction = (tag: Tag, size: number, color: string) => JSX.Element;
